...
\item Supports a variety of \emph{solvers} for performing inference, including sum-product and Gaussian belief propagation (BP), min-sum BP, particle BP, linear programming (LP), and Gibbs sampling.
