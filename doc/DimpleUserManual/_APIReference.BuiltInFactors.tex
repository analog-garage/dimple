...
%
FiniteFieldProjection & fieldVar(F) \newline indices(const) \newline bits...(B) & - & Deterministic projection of a finite field variable onto one or more bit variables.  The indices argument is a constant array of indices, each representing a bit-position of the finite field variable expressed in bit-wise representation to project onto the corresponding Bit variable in the list of bits.  See section~\ref{sec:finiteFields} for a description of how to use finite field variables. \\
%
