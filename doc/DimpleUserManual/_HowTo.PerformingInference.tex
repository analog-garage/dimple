...
The current set of solvers is:\footnote{Dimple also supports and LP solver, but this solver is only accessible via the MATLAB API.}
...
For all of the BP solvers (SumProduct, MinSum, ParticleBP), the following schedulers are available.  More detail on each of these schedulers is provided in section~\ref{sec:FactorGraph.Scheduler}.
