...
% Force sections and subsections to new page.
...
% This macro is used to create a structured paragraph documenting a Dimple option.
\newcommand{\dimpleOption}[5]{
\label{option:#1}
