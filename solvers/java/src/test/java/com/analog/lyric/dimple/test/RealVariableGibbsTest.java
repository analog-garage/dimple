...
//		Real a = new Real();
		...
		assertTrue(nearlyEquals(aMean,0.23397768877018008));
		assertTrue(nearlyEquals(bMean,0.6149));
		assertTrue(nearlyEquals((Double)sa.getBestSample(),0.9780957415790205));
