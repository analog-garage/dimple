 ...
 * 2...dimension+1) Alpha: A number of Real variables containing energy values, where
...
public class MultinomialEnergyParameters extends FactorFunction
{
	...
	public double evalEnergy(Object... arguments)
    {
    	...
    	for (int i = 0; i < _dimension; i++)
    		_alpha[i] = FactorFunctionUtilities.toDouble(arguments[index++]);	// Next _dimension arguments are vector of Alpha parameters
