...
/**
 * Deterministic arc-sine function. This is a deterministic directed factor
 ...
 * 
 * 1) Output (arc-sine of input)
 * 2) Input (double or integer)
 * 
 */
public class ASin extends DeterministicRealUnaryFactorFunction
{
