...
public class SumProductOptions extends SolverOptions
{
	...
	public static final EnumOptionKey<UpdateApproach> updateApproach = new EnumOptionKey<UpdateApproach>(
		SumProductOptions.class, "updateApproach", UpdateApproach.class, UpdateApproach.AUTOMATIC);
	 ...
	 * @since 0.07
	 */
	public static final DoubleOptionKey automaticExecutionTimeScalingFactor = new DoubleOptionKey(SumProductOptions.class,
	...
	public static final DoubleOptionKey automaticMemoryAllocationScalingFactor = new DoubleOptionKey(
		SumProductOptions.class, "automaticMemoryAllocationScalingFactor", 10.0, 0.0, Double.POSITIVE_INFINITY);
	 ...
	 * @since 0.07
	 */
	public static final DoubleOptionKey optimizedUpdateSparseThreshold = new DoubleOptionKey(SumProductOptions.class,
