...
/**
 * Deterministic arc-cosine function. This is a deterministic directed factor
 ...
 * 
 * 1) Output (arc-cosine of input)
 * 2) Input (double or integer)
 * 
 */
public class ACos extends DeterministicRealUnaryFactorFunction
{
