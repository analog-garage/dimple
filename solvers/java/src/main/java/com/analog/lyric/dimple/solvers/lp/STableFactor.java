...
public class STableFactor extends STableFactorBase
{
	...
	/**
	 * It is assumed that {@link SVariable#computeValidAssignments()} has already been invoked on the variables
