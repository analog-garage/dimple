...
/**
 * Deterministic hyperbolic tangent function. This is a deterministic directed factor
 ...
 * 
 * 1) Output (hyperbolic tangent of input)
 * 2) Input (double or integer)
 * 
 */
public class Tanh extends DeterministicRealUnaryFactorFunction
{
