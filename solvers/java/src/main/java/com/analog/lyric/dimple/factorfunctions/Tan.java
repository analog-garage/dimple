...
/**
 * Deterministic tangent function. This is a deterministic directed factor
 ...
 * 
 * 1) Output (tangent of input)
 * 2) Input (double or integer)
 * 
 */
public class Tan extends DeterministicRealUnaryFactorFunction
{
