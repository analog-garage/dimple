...
/**
 * Deterministic arc-tangent function. This is a deterministic directed factor
 ...
 * 
 * 1) Output (arc-tangent of input)
 * 2) Input (double or integer)
 * 
 */
public class ATan extends DeterministicRealUnaryFactorFunction
{
