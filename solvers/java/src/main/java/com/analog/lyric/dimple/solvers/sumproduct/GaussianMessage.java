...
public class GaussianMessage
{
	private double _mean = 0;
	private double _precision = 0;
	
	public GaussianMessage() {}
	public GaussianMessage(double mean, double precision)
	{
		_mean = mean;
		_precision = precision;
	}
	public GaussianMessage(GaussianMessage other)		// Copy constructor
	{
	...
	public final void set(GaussianMessage other)	// Set from copy
	{
		_mean = other._mean;
