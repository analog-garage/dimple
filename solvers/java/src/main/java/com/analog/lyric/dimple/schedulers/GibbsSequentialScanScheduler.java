...
import com.analog.lyric.dimple.schedulers.schedule.GibbsSequentialScanSchedule;
import com.analog.lyric.dimple.schedulers.schedule.ISchedule;

/**
 * @author jeffb
 * 
 *         This creates a dynamic schedule, which updates only one variable at a
...
public class GibbsSequentialScanScheduler implements IScheduler
{
	...
	{
		return new GibbsSequentialScanSchedule(g);
	}
}
