...
public final class CostEstimationTableWrapper
{
	...
	{
		this(getFactorTableDimensions(factorTable), factorTable.density(), sFactorGraphAdapter, sFactorGraphAdapter
			.getFactorTableUpdateSettings(factorTable).getOptimizedUpdateSparseThreshold());
	}
