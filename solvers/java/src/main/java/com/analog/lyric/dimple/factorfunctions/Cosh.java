...
/**
 * Deterministic hyperbolic cosine function. This is a deterministic directed factor
 ...
 * 
 * 1) Output (hyperbolic cosine of input)
 * 2) Input (double or integer)
 * 
 */
public class Cosh extends DeterministicRealUnaryFactorFunction
{
