...
public class MultinomialUnnormalizedParameters extends FactorFunction
{
	...
	protected boolean _NParameterConstant;
	private double[] _alpha;
	private int _firstDirectedToIndex;

	public MultinomialUnnormalizedParameters(int dimension)				// Variable N
	{
		super();
	...
	public MultinomialUnnormalizedParameters(int dimension, int N)		// Fixed N
	{
		super();
		_dimension = dimension;
		_N = N;
