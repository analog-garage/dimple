...
public class TableFactorEngineOptimized extends TableFactorEngine
{
	...
	static ITableWrapperAdapter getHelper(final UpdateSettings factorTableOptimizationSettings)
	{
		return new ITableWrapperAdapter() {
			...
			{
				return factorTableOptimizationSettings.getOptimizedUpdateSparseThreshold();
			}
		};
	}
