...
/**
 * Deterministic cosine function. This is a deterministic directed factor
 ...
 * 
 * 1) Output (cosine of input)
 * 2) Input (double or integer)
 * 
 */
public class Cos extends DeterministicRealUnaryFactorFunction
{
