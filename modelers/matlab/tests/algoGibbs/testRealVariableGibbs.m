...
assertElementsAlmostEqual(aMean, 0.202331249964141);
assertElementsAlmostEqual(bMean, 0.604900000000000);
assertElementsAlmostEqual(sa.getBestSample(), 0.977629651682682);
